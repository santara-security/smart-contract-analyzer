...
export default function SmartContractAnalyzer() {
  ...
  const [isContractInputVisible, setIsContractInputVisible] = useState(true);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const assistantMessage = {
        ...
        content: data.text,
        toolInvocations:
          data.toolCalls?.length > 0 ? data.toolCalls : undefined,
      };
    ...
    <div className="bg-transparent z-10 flex flex-col px-8 py-10 gap-10 mt-20 max-w-8xl mx-auto">
      <div className="bg-neutral-900/20 bg-opacity-50 backdrop-blur-md rounded-xl shadow-xl p-8 md:p-10">
        ...
        <div className="flex justify-end mb-4">
          <button
            onClick={() => setIsContractInputVisible(!isContractInputVisible)}
            className="text-xs bg-neutral-700/50 hover:bg-neutral-700 text-neutral-300 px-3 py-1.5 rounded border border-neutral-600/30 hover:border-neutral-500 transition-all flex items-center"
          >
        ...
        >
          ...
          <div className="bg-neutral-800/30 rounded-lg p-4 space-y-4 flex flex-col h-full">
            ...
            <div
              ...
              className="flex-grow overflow-y-auto max-h-[500px] space-y-4 pr-2 scrollbar-thin scrollbar-thumb-neutral-600 scrollbar-track-transparent scrollbar-thumb-rounded"
            >
              {messages.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-xs text-neutral-400 mb-4">
                    {contractCode
                      ? "Ask a question about your smart contract to get started"
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        {quickPrompts.map((prompt, index) => (
                          <button
                            ...
                            className="text-sm bg-neutral-700/50 hover:bg-neutral-700 text-neutral-300 px-3 py-3 rounded-lg border border-neutral-600/30 hover:border-neutral-500 transition-all flex items-center justify-center"
                          >
            ...
            <form onSubmit={handleSubmit} className="mt-auto">
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 p-3 text-sm bg-neutral-700/50 text-neutral-200 rounded-lg border border-neutral-600/30 focus:border-blue-500/50 focus:ring-1 focus:ring-blue-500/30 outline-none transition-all"
                  disabled={isLoading || !contractCode}
                />
                <button
                  type="submit"
                  disabled={isLoading || !input.trim() || !contractCode}
                  className="flex items-center justify-center px-4 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-600/50 disabled:cursor-not-allowed text-white rounded-lg text-sm font-medium transition-colors border border-blue-500/30"
                >
                  {isLoading ? (
